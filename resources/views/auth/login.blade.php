...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('assets/global/plugins/uniform/css/uniform.default.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('assets/global/plugins/uniform/css/uniform.default.css')}}">
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('assets/global/css/components-rounded.min.css')}}">
